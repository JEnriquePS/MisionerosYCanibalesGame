...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "PythonJuego.py"

        #Name of program
        self.project_name = "canibales y misioneros"

        #Project url
        self.project_url = "about:none"

        #Version of program
        self.project_version = "0.99"

        #License of the program
        self.license = "o-o License"

        #Auhor of program
        self.author_name = "Me"
        self.author_email = "jenrique.ps@gmail.com"
        self.copyright = "Copyright (c) 2015 Me."

        #Description
        self.project_description = "Juego de canibales y misisoneros. rojecto UNICA"

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ["myc","Text/opciones.py"]
